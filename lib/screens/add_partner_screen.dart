...
class _AddPartnerScreenState extends State<AddPartnerScreen> {
  ...
  Future<void> _savePartner() async {
    ...
    final partner = Partner(name: _nameController.text.trim(), photoPath: _photo?.path);
    try {
      await DBHelper.instance.insertPartner(partner);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Add Partner'), backgroundColor: Colors.white, foregroundColor: const Color(0xFF1C1C1E), elevation: 0, shape: const Border(bottom: BorderSide(color: Color(0xFFE8E8E4)))),
      body: Padding(
          ...
          child: ListView(
            children: [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(labelText: 'Partner Name', prefixIcon: Icon(Icons.people_outline, size: 18)),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: _saving ? null : _savePartner,
                  ...
                  child: _saving
                      ...
                      : const Text('Save Partner', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600)),
                ),
              ),
            ],
          ),
